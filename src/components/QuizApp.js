...
import { Camera, Instagram, Copy, ChevronRight } from 'lucide-react';
        ...
        <AnimatePresence mode="wait">
          {!quizStarted ? (
            ...
            >
              ...
              >
                <Image 
                  src={`/img/question_${currentQuestion + 1}.png`} 
            ...
            >
              ...
              <div className="flex justify-center space-x-4 mb-4">
                ...
                >
                  <Image 
                    src={`/img/${result.name.toLowerCase()}_1.png`} 
                    alt={result.name} 
                    width={200} 
                    height={300} 
                    className="rounded-lg shadow-md"
                ...
                >
                  <Image 
                    src={`/img/${result.name.toLowerCase()}_2.png`} 
                    alt={result.name} 
                    width={200} 
                    height={300} 
                    className="rounded-lg shadow-md"
              ...
              whileTap={{ scale: 0.95 }}
              onClick={shareResult}
              className="bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-2 px-4 rounded-full inline-flex items-center hover:from-purple-600 hover:to-pink-600 transition duration-300"
            >
